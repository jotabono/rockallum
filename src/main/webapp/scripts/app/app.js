...
angular.module('therockbibleApp', ['LocalStorageModule', 'tmh.dynamicLocale', 'pascalprecht.translate',
        ...
        'ui.bootstrap', 'ui.router',  'infinite-scroll', 'angular-loading-bar', 'ui.select', 'ngSanitize', 'ngMap', 'ngMaterial', 'hm.readmore', 'textAngular'])
    ...
    .config(function ($stateProvider, $urlRouterProvider, $httpProvider, $locationProvider, $translateProvider, tmhDynamicLocaleProvider, httpRequestInterceptorCacheBusterProvider, AlertServiceProvider) {
        ...
        $stateProvider.state('site', {
            ...
            views: {
                ...
                'navbarlateral@':{
                    templateUrl: 'scripts/components/navbar/navbarlateral.html',
                    controller: 'NavbarController'
                }
            },
            resolve: {
