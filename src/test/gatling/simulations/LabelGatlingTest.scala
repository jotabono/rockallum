...
class LabelGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Label entity")
        ...
        .repeat(2) {
            ...
            .post("/api/labels")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "foundingDate":"SAMPLE_TEXT", "location":"SAMPLE_TEXT", "status":"SAMPLE_TEXT", "genres":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "addNotes":"SAMPLE_TEXT", "links":"SAMPLE_TEXT", "phone":"SAMPLE_TEXT", "address":"SAMPLE_TEXT", "onlineshop":"SAMPLE_TEXT", "picture":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
